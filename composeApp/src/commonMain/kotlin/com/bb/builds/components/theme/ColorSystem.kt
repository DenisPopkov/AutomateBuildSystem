...
data class ColorSystem(
    ...
    val orangeGradient: Brush = Brush.linearGradient(listOf(Color(0xFFFF7A00), Color(0xFFDB2D06))),
    val dark: Color = Color(0xFF20242C),
    val devices: Color = Color(0xFFD254D7),
    val grey: Color = Color(0xFF666666),
    val library: Color = Color(0xFF74D615),
    val crlPanel: Color = Color(0xFF414141),
    val activeCard: Color = Color(0xFF15D66E),
    val activeCard30: Color = Color(0x4D15D66E),
    val blue: Color = Color(0xFF13A9F0),
    val lightBlue: Color = Color(0xFF59A5FF),
    val lightBackground: Color = Color(0xFFE9F0F8),
    val search: Color = Color(0xFFF9B215),
    ...
    val soundcheckBgBars: Color = Color(0xFF0F0F0F),
    val bgBarsNotTransparent: Color = bgBars.copy(alpha = 1f),
    val laLady: Color = Color(0xFFA47114),
    ...
    val smokyTopaz: Color = Color(0xFFA1384C),
    ...
    val bgScrim: Color = Color(0x99000000),
    val pedalBg: Color = Color(0xFF2C2C2C),
    val popup: Color = Color(0xFF404040),
